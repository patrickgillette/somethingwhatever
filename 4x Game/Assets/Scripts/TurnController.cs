...
public class TurnController : MonoBehaviour {
    ...
    public void Update()
    {
        ...
        // Is a Colony waiting with an empty production queue?
    }
    ...
    public void EndTurn()
    {
        Debug.Log("EndTurn");
        Unit[] units = hexMap.CurrentPlayer.Units;
        Colony[] colonies = hexMap.CurrentPlayer.Colonies;
        ...
        // If we get to this point, no units are waiting for orders, so process colonies
        ...
        selectionController.SelectedColony = null;
        hexMap.AdvanceToNextPlayer();
