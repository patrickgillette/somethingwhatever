...
public class UnitSelectionPanel : MonoBehaviour {
    ...
    public GameObject ColonyBuildButton;
	...
	void Update () {
        ...
        if(selectionController.SelectedUnit != null)
        {
            ...
            /*if( selectionController.SelectedUnit.CanBuildColonies && selectionController.SelectedUnit.Hex.Colony == null)
            {
                ColonyBuildButton.SetActive( true );
            }
            else
            {
                ColonyBuildButton.SetActive( false );
            }*/
